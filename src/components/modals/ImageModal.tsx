...
export default function ImageModal() {
    ...
    return (
        <motion.div
            ...
            className='fixed z-20 w-[75%] top-1/2 left-1/2 p-8 mt-8 -translate-x-1/2 -translate-y-1/2 bg-white dark:bg-dark-primary flex flex-col gap-4 rounded-lg'>
            ...
            <Image src={modalImage.image || ''} alt='modalImage' className='shadow-lg' />
        </motion.div>
    )
}
